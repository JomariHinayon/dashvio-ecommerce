...
<section class="dashvio-demo-section--health">
    <div class="dashvio-demo-container--health">
        <h2 class="dashvio-demo-title--health">Our Values</h2>
        <p class="dashvio-demo-subtitle--health">The principles that guide our commitment to excellence</p>
        ...
        <div class="dashvio-demo-features--health">
            ...
            <div class="dashvio-demo-feature--health">
                ...
                <h3>Excellence</h3>
                <p>We strive for the highest standards in medical care, continuously improving our services.</p>
            </div>
            ...
            <div class="dashvio-demo-feature--health">
                ...
                <h3>Innovation</h3>
                <p>We embrace new technologies and methods to provide cutting-edge medical solutions.</p>
            </div>
            ...
            <div class="dashvio-demo-feature--health">
                ...
                <h3>Integrity</h3>
                <p>We maintain the highest ethical standards in all our practices and interactions.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="dashvio-demo-section--health">
    <div class="dashvio-demo-container--health">
        <h2 class="dashvio-demo-title--health">Our Medical Team</h2>
        <p class="dashvio-demo-subtitle--health">Meet the dedicated professionals committed to your health</p>
        ...
        <div class="dashvio-demo-grid--health">
            <div class="dashvio-demo-card--health" style="padding: 0; text-align: left;">
                ...
                <div style="padding: 2rem;">
                    ...
                    <p>Board-certified cardiologist with 20+ years of experience in cardiovascular medicine and patient care.</p>
                </div>
            </div>
            ...
            <div class="dashvio-demo-card--health" style="padding: 0; text-align: left;">
                ...
                <div style="padding: 2rem;">
                    ...
                    <p>Renowned surgeon specializing in minimally invasive procedures and advanced surgical techniques.</p>
                </div>
            </div>
            ...
            <div class="dashvio-demo-card--health" style="padding: 0; text-align: left;">
                ...
                <div style="padding: 2rem;">
                    ...
                    <p>Dedicated pediatrician focused on providing comprehensive care for children and adolescents.</p>
                </div>
            </div>
        </div>
    </div>
