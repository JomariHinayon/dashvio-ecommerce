<section class="dashvio-demo-section--gadgets" style="padding-top: 3rem;">
    <div class="dashvio-demo-container--gadgets">
        <h1 class="dashvio-demo-title--gadgets">Contact Us</h1>
        <p class="dashvio-demo-subtitle--gadgets">Have questions? We're here to help you find the perfect tech solution</p>
    </div>
</section>

<section class="dashvio-demo-cta--gadgets" style="margin-top: 0;">
    <div class="dashvio-demo-container--gadgets">
        <div style="max-width: 800px; margin: 0 auto;">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 3rem; margin-bottom: 4rem; text-align: left;">
                <div>
                    ...
                    <p style="opacity: 0.9; margin: 0;">123 Tech Street<br>San Francisco, CA 94102<br>United States</p>
                </div>
                ...
                <div>
                    ...
                    <p style="opacity: 0.9; margin: 0;">hello@techhub.com<br>support@techhub.com</p>
                </div>
                ...
                <div>
                    ...
                    <p style="opacity: 0.9; margin: 0;">+1 (234) 567-8900<br>Mon-Fri: 9AM - 6PM PST</p>
                </div>
            </div>
    ...
    <div class="dashvio-demo-container--gadgets">
        ...
        <div style="max-width: 800px; margin: 0 auto; text-align: left;">
            <div style="margin-bottom: 2rem; padding: 1.5rem; background: var(--gadget-light); border-radius: 12px;">
                ...
                <p style="color: #666; line-height: 1.7;">We offer a 30-day return policy for all products. If you're not satisfied, you can return the item for a full refund or exchange.</p>
            </div>
            
            <div style="margin-bottom: 2rem; padding: 1.5rem; background: var(--gadget-light); border-radius: 12px;">
                <h3 style="color: var(--gadget-primary); margin-bottom: 0.75rem;">Do you ship internationally?</h3>
                <p style="color: #666; line-height: 1.7;">Yes, we ship to over 50 countries worldwide. Shipping costs and delivery times vary by location.</p>
            </div>
            
            <div style="margin-bottom: 2rem; padding: 1.5rem; background: var(--gadget-light); border-radius: 12px;">
                <h3 style="color: var(--gadget-primary); margin-bottom: 0.75rem;">Are your products covered by warranty?</h3>
